...
/*   Updated: 2020/01/19 10:50:49 by jkauppi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		loop_down_if_swap(t_sort_result *sort_result)
{
	...
	current = sort_result->stack_index.top;
	current_1 = current ? current - 1 : sort_result->stack_size - 1;
	is_sorted = 1;
	while (current_1 != sort_result->stack_index.top)
	{
...
void			bubble_sort_v2(t_sort_result *sort_result)
{
	...
	if (sort_result->stack[sort_result->stack_index.top] > sort_result->median)
	{
